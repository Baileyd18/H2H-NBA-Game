# H2H MODULE VERSION: role_locked_team_name_only_v3
...
def render_head_to_head_mode(
    ...
    # Light live sync: useful for Player 2 while Player 1 advances games.
    sync_col1, sync_col2 = st.columns([0.55, 0.45])
    with sync_col1:
        live_sync = st.toggle("Live sync / auto-refresh", value=(role == "p2"), key="h2h_live_sync_v2")
    with sync_col2:
